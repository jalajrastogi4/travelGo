...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWthdGRyYXEiLCJhIjoiY2sydjI3ZmQ4MDBrNDNvcGdjMDNvbjE0cSJ9.c4oe_rd3E6S2mQddO5a2bQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/akatdraq/ck2v2itaq0cuq1cli5ccf77i4',
      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Signed Up in successfully! Please check your email');
...
/* eslint-disable */
var stripe = Stripe('pk_test_Jus8m9mETnM11IRIXOjt7OhJ00ivm6N8ae');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "22250" + '/');
